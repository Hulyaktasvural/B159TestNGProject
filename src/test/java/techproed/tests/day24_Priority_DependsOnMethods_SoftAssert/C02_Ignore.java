...
public class C02_Ignore {
    ...
    /*
      Birden fazla test methodu çalıştırmak istediğimizde o anlık gereksiz gördüğümüz test methodunu atlamak(ignore)
    isteyebiliriz. Bunun için @Test notasyonu üstüne yada yanına @Ignore notasyonu
