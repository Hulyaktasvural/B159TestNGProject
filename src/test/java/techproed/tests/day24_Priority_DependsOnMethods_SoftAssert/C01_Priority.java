...
public class C01_Priority {
    /*
     ...
     olarak yazmamız gerekiyordu. TestNG frameworkunda bu sıralama için @test notasyonundan sonra parametre olarak
    (priority =1) gibi öncelik sırası belirterek test methodlarımızı sıralayabilirizz.
